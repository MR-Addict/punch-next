...
值班笔记默认不适用 Markdown，你需要手动勾选**使用 Markdown**，才能使用 Markdown 语法书写，这是为了照顾大部分同学不会使用 Markdown 的情况。

如果你想使用 Markdown 语法，勾选使用 Markdown后，文本输入框会弹出一个**放大**按钮，点击即可进入编辑器编辑，方便书写和预览。
...
之所以把换行放在第一位，是因为这是最基础的一个功能，也是最容易被忽略的一个功能。
